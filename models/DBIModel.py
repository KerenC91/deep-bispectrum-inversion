...
class DBIModel(nn.Module):
    ...
    def _set_trsnsformer_layers(self):
    ...
    def _update_reduce_height_cnt(self, reduce_height, Hin):
        """
    ...
    def _set_reduce_height(self, reduce_height, input_len):
        reduce_height = self._update_reduce_height_cnt(reduce_height, input_len)
        c1 = self.embed_dim
